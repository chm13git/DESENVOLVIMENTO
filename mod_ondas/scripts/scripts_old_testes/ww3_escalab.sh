...
do
  ...
  do    
    ...
    for ii in `seq 1 3`
      ...
      ln -s ${gelodir}/ice.${DATAi}_${DATAf}_${grd}.ice ${workdir}/ice.${grd}
      ventodir=${ww3dir}/input/vento/${wnd}
      ln -s ${ventodir}/wind.${DATAi}_${DATAf}_${grd}.${wnd} ${workdir}/wind.${grd}
      done

    ln -s ${grddir}/mod_def.points ${workdir}/mod_def.points
